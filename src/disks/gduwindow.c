...
create_header (GduWindow *window)
{
  ...
  window->devtab_drive_menu_button = GTK_WIDGET (gtk_builder_get_object (window->builder, "drive-menu-button"));
  window->devtab_app_menu_button = GTK_WIDGET (gtk_builder_get_object (window->builder, "app-menu-button"));
  window->devtab_drive_power_off_button = GTK_WIDGET (gtk_builder_get_object (window->builder, "power-off-disk-button"));
                            ...
                            gpointer       user_data)
{
  ...
  gdu_resize_dialog_show (GTK_WINDOW (window), object, window->client);
}
                                ...
                                gpointer       user_data)
{
  ...
  object = gdu_volume_grid_get_selected_device (GDU_VOLUME_GRID (window->volume_grid));
  g_assert (object != NULL);
  gdu_filesystem_dialog_show (GTK_WINDOW (window), object, window->client);
}
                                    ...
                                    gpointer       user_data)
{
  ...
  object = gdu_volume_grid_get_selected_device (GDU_VOLUME_GRID (window->volume_grid));
  g_assert (object != NULL);
  gdu_partition_dialog_show (GTK_WINDOW (window), object, window->client);
}
...
{
  GduWindow *window = GDU_WINDOW (user_data);
  gdu_disk_settings_dialog_show (GTK_WINDOW (window), window->current_object, window->client);
}
                                        ...
                                        gpointer       user_data)
{
  ...
  if (object == NULL)
    object = gdu_volume_grid_get_block_object (GDU_VOLUME_GRID (window->volume_grid));
  gdu_crypttab_dialog_show (GTK_WINDOW (window), object, window->client);
}
