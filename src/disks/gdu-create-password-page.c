...
gdouble
gdu_password_strength (const gchar *password, const gchar **hint, gint *strength_level)
{
    gint rv, level, length = 0;
    gdouble strength = 0.0;
    void *auxerror;

    rv = pwquality_check (get_pwq (), password, NULL, /* old_password */
                          NULL,                       /* username */
                          &auxerror);
...
static void
gdu_create_password_page_get_property (GObject *object, guint property_id, GValue *value, GParamSpec *pspec)
{
