...
GduBlock *gdu_block_new (gpointer udisk_client, gpointer udisk_object, GduItem *parent);
GduBlock *gdu_block_sized_new (gpointer udisk_client, guint64 start_offset, guint64 size, GduItem *parent);
...
void gdu_block_set_fs_label_async (GduBlock *self, const char *label, GAsyncReadyCallback callback, gpointer user_data);
