...
static int (*dvdcss_seek) (dvdcss_t ctx, int i_blocks, int i_flags) = NULL;
static int (*dvdcss_read) (dvdcss_t ctx, void *p_buffer, int i_blocks, int i_flags) = NULL;
static int (*dvdcss_readv) (dvdcss_t ctx, void *p_iovec, int i_blocks, int i_flags) = NULL;
...
gssize
gdu_dvd_support_read (GduDVDSupport *support, int fd, guchar *buffer, guint64 offset, guint64 size)
{
    guint n;
    gssize ret = -1;
