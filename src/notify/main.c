...
main (gint argc, gchar *argv[])
{
     ...
     */
    name_owner_id = g_bus_own_name (G_BUS_TYPE_SESSION, "org.gnome.Disks.NotificationMonitor",
                                    G_BUS_NAME_OWNER_FLAGS_ALLOW_REPLACEMENT | G_BUS_NAME_OWNER_FLAGS_REPLACE,
                                    NULL, /* bus_acquired_handler */
                                    name_acquired_handler, name_lost_handler, &monitor, NULL); /* GDestroyNotify */
