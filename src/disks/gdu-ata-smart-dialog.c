...
static const struct {
    goffset offset;
    const gchar *name;
} widget_mapping[] = { { G_STRUCT_OFFSET (DialogData, enabled_switch), "enabled-switch" },
    ...
    { "raw-read-error-rate",
     ...
     "either the disk surface or read/write heads") },
      { "throughput-performance",
         ...
         * or the next string for a longer explanation.
         */
        N_("Throughput Performance"), N_("Average efficiency of the disk") },
        { "spin-up-time",
          /* Translators: SMART attribute, see http://smartmontools.sourceforge.net/doc.html
           * or the next string for a longer explanation.
           */
          N_("Spinup Time"), N_("Time needed to spin up the disk") },
          { "start-stop-count",
            /* Translators: SMART attribute, see http://smartmontools.sourceforge.net/doc.html
             * or the next string for a longer explanation.
             */
            N_("Start/Stop Count"), N_("Number of spindle start/stop cycles") },
     ...
     "as “reallocated” and transfers data to a special reserved area (spare area)") },
              { "read-channel-margin",
                 ...
                 * or the next string for a longer explanation.
                 */
                N_("Read Channel Margin"), N_("Margin of a channel while reading data.") },
                { "seek-error-rate",
                  /* Translators: SMART attribute, see http://smartmontools.sourceforge.net/doc.html
                   * or the next string for a longer explanation.
                   */
                  N_("Seek Error Rate"), N_("Frequency of errors while positioning") },
                  { "seek-time-performance",
                    /* Translators: SMART attribute, see http://smartmontools.sourceforge.net/doc.html
                     * or the next string for a longer explanation.
                     */
                    N_("Seek Timer Performance"), N_("Average efficiency of operations while positioning") },
                    { "power-on-hours",
                      /* Translators: SMART attribute, see http://smartmontools.sourceforge.net/doc.html
                       * or the next string for a longer explanation.
                       */
                      N_("Power-On Hours"), N_("Number of hours elapsed in the power-on state") },
                      { "spin-retry-count",
                        /* Translators: SMART attribute, see http://smartmontools.sourceforge.net/doc.html
                         * or the next string for a longer explanation.
                         */
                        N_("Spinup Retry Count"), N_("Number of retry attempts to spin up") },
                        { "calibration-retry-count",
                          /* Translators: SMART attribute, see http://smartmontools.sourceforge.net/doc.html
                           * or the next string for a longer explanation.
                           */
                          N_("Calibration Retry Count"), N_("Number of attempts to calibrate the device") },
                          { "power-cycle-count",
                            /* Translators: SMART attribute, see http://smartmontools.sourceforge.net/doc.html
                             * or the next string for a longer explanation.
                             */
                            N_("Power Cycle Count"), N_("Number of power-on events") },
                              ...
                              { "reported-uncorrect",
                                ...
                                { "high-fly-writes",
                                  ...
                                  { "airflow-temperature-celsius",
                                     ...
                                     * or the next string for a longer explanation.
                                     */
                                    N_("Airflow Temperature"), N_("Airflow temperature of the drive") },
                                    { "g-sense-error-rate",
                                      /* Translators: SMART attribute, see http://smartmontools.sourceforge.net/doc.html
                                       * or the next string for a longer explanation.
                                       */
                                      ...
                                      { "power-off-retract-count",
                                         ...
                                         * http://smartmontools.sourceforge.net/doc.html or the next string for a longer
                                         * explanation.
                                         */
                                        ...
                                        { "load-cycle-count",
                                          /* Translators: SMART attribute, see
                                           * http://smartmontools.sourceforge.net/doc.html or the next string for a
                                           * longer explanation.
                                           */
                                          ...
                                          { "temperature-celsius-2",
                                             ...
                                             * longer explanation.
                                             */
                                            N_("Temperature"), N_("Current internal temperature of the drive") },
                                            { "hardware-ecc-recovered",
                                              /* Translators: SMART attribute, see
                                               * http://smartmontools.sourceforge.net/doc.html or the next string for a
                                               * longer explanation.
                                               */
                                              N_("Hardware ECC Recovered"), N_("Number of ECC on-the-fly errors") },
                                              { "reallocated-event-count",
                                                /* Translators: SMART attribute, see
                                                 * http://smartmontools.sourceforge.net/doc.html or the next string for
     ...
     "to a spare area") },
                                                { "current-pending-sector",
                                                  /* Translators: SMART attribute, see
                                                   * http://smartmontools.sourceforge.net/doc.html or the next string
     ...
     "disk surface and/or problems in the mechanical subsystem") },
                                                    { "udma-crc-error-count",
                                                      /* Translators: SMART attribute, see
                                                       * http://smartmontools.sourceforge.net/doc.html or the next
                                                       * string for a longer explanation.
                                                       */
                                                      ...
                                                      { "multi-zone-error-rate",
                                                        ...
                                                        { "soft-read-error-rate",
                                                          ...
                                                          { "ta-increase-count",
                                                            ...
                                                            { "run-out-cancel",
                                                              /* Translators: SMART attribute, see
                                                               * http://smartmontools.sourceforge.net/doc.html or the
                                                               * next string for a longer explanation.
                                                               */
                                                              N_("Run Out Cancel"), N_("Number of ECC errors") },
                                                              { "shock-count-write-open",
                                                                ...
                                                                { "shock-rate-write-open",
                                                                  /* Translators: SMART attribute, see
                                                                   * http://smartmontools.sourceforge.net/doc.html or
                                                                   * the next string for a longer explanation.
                                                                   */
                                                                    ...
                                                                    { "spin-high-current",
                                                                      ...
                                                                      { "spin-buzz",
                                                                        ...
                                                                        { "offline-seek-performance",
                                                                          /* Translators: SMART attribute, see
                                                                           * http://smartmontools.sourceforge.net/doc.html
                                                                           * or the next string for a longer
                                                                           * explanation.
                                                                           */
...
static gboolean
attribute_get_details (const gchar *name, const gchar **out_name, const gchar **out_desc)
{
    ...
    if (g_once_init_enter (&have_hash)) {
        ...
        for (n = 0; smart_details[n].name != NULL; n++) {
            g_hash_table_insert (smart_details_map, (gpointer) smart_details[n].name, (gpointer) & (smart_details[n]));
        }
...
static gchar *
attr_format_assessment (gint current, gint worst, gint threshold, guint16 flags)
{
    gchar *ret;
...
static gchar *
pretty_to_string (guint64 pretty, gint pretty_unit)
{
    gchar *ret;
    gdouble celcius;
    gdouble fahrenheit;
    ...
    case 2: /* SK_SMART_ATTRIBUTE_UNIT_MSECONDS */
        ret = gdu_utils_format_duration_usec (pretty * 1000, GDU_FORMAT_DURATION_FLAGS_SUBSECOND_PRECISION);
        break;
    ...
    case 3: /* SK_SMART_ATTRIBUTE_UNIT_SECTORS */
        ret = g_strdup_printf (dngettext (GETTEXT_PACKAGE,
                                           ...
                                           * attribute for a sector-based unit */
                                          "%d sector", "%d sectors", (gint) pretty),
                               (gint) pretty);
        break;
...
static gchar *
calculate_self_test (UDisksDriveAta *ata, gboolean *out_selftest_running)
{
    const gchar *s;
    gchar *ret;
    ...
    if (g_strcmp0 (s, "success") == 0) {
        ...
        /* Translators: shown when the last self-test failed and the disk is suspected of having handling damage (e.g.
...
format_powered_on (UDisksDriveAta *ata)
{
    ...
    if (secs > 0)
        ret = gdu_utils_format_duration_usec (secs * G_USEC_PER_SEC, GDU_FORMAT_DURATION_FLAGS_NONE);
    return ret;
}
                                      ...
                                      gboolean *out_warn)
{
    ...
    if (udisks_drive_ata_get_smart_failing (ata)) {
        ...
        if (one_liner && selftest != NULL) {
            ...
            ret = g_strdup_printf ("<span foreground=\"#ff0000\"><b>%s</b></span> — %s",
                                   _("DISK IS LIKELY TO FAIL SOON"), selftest);
        } else {
            /* TODO: once https://bugzilla.gnome.org/show_bug.cgi?id=657194 is resolved, use that instead
             * of hard-coding the color
             */
            ret = g_strdup_printf ("<span foreground=\"#ff0000\"><b>%s</b></span>", _("DISK IS LIKELY TO FAIL SOON"));
        }
        warn = TRUE;
        goto out;
    }
    ...
    if (g_str_has_prefix (udisks_drive_ata_get_smart_selftest_status (ata), "error")) {
         ...
         * of hard-coding the color
         */
        ret = g_strdup_printf ("<span foreground=\"#ff0000\"><b>%s</b></span>", _("SELF-TEST FAILED"));
        warn = TRUE;
        goto out;
    }
    ...
    if (num_failing > 0) {
        ret = g_strdup_printf (dngettext (GETTEXT_PACKAGE, "Disk is OK, one failing attribute is failing",
                                          "Disk is OK, %d attributes are failing", num_failing),
                               num_failing);
        goto out;
    }
    ...
    if (num_bad_sectors > 0) {
        ret = g_strdup_printf (
            dngettext (GETTEXT_PACKAGE, "Disk is OK, one bad sector", "Disk is OK, %d bad sectors", num_bad_sectors),
            num_bad_sectors);
        goto out;
    }
    ...
    if (num_failed_in_the_past > 0) {
        ret = g_strdup_printf (dngettext (GETTEXT_PACKAGE, "Disk is OK, one attribute failed in the past",
                                          "Disk is OK, %d attributes failed in the past", num_failed_in_the_past),
...
gchar *
gdu_ata_smart_get_one_liner_assessment (UDisksDriveAta *ata, gboolean *out_smart_is_supported, gboolean *out_warn)
{
...
static void
update_attributes_list (DialogData *data, GVariant *attributes)
{
    ...
    if (gtk_tree_selection_get_selected (gtk_tree_view_get_selection (GTK_TREE_VIEW (data->attributes_treeview)), NULL,
                                         &tree_iter)) {
        gtk_tree_model_get (GTK_TREE_MODEL (data->attributes_list), &tree_iter, ID_COLUMN, &selected_id, -1);
    }
    ...
    if (attributes != NULL) {
        ...
        while (g_variant_iter_next (&iter, "(y&sqiiixi@a{sv})", &id, &name, &flags, &current, &worst, &threshold,
                                    &pretty, &pretty_unit, &expansion)) {
            GtkTreeIter titer;
            gchar *long_desc_str;
            gchar *desc_str;
            ...
            gtk_list_store_set (data->attributes_list, &titer, ID_COLUMN, (gint) id, DESC_COLUMN, desc_str,
                                LONG_DESC_COLUMN, long_desc_str, ASSESSMENT_COLUMN, assessment_str, PRETTY_COLUMN,
                                pretty_str, NORMALIZED_COLUMN, current_str, THRESHOLD_COLUMN, threshold_str,
                                WORST_COLUMN, worst_str, TYPE_COLUMN, type_str, UPDATES_COLUMN, updates_str,
                                FLAGS_COLUMN, flags, -1);
...
static void
on_ata_notify (GObject *object, GParamSpec *pspec, gpointer user_data)
{
...
{
    udisks_drive_ata_call_smart_update (data->ata, g_variant_new ("a{sv}", NULL), /* options */
                                        NULL,                                     /* GCancellable */
                                        (GAsyncReadyCallback) refresh_cb, g_object_ref (data->window));
}
...
static void
selftest_do (DialogData *data, const gchar *type)
{
    if (g_strcmp0 (type, "abort") == 0) {
        udisks_drive_ata_call_smart_selftest_abort (data->ata, g_variant_new ("a{sv}", NULL), /* options */
                                                    NULL,                                     /* GCancellable */
                                                    (GAsyncReadyCallback) smart_cancel_cb, g_object_ref (data->window));
    } else {
        udisks_drive_ata_call_smart_selftest_start (data->ata, type, g_variant_new ("a{sv}", NULL), /* options */
                                                    NULL,                                           /* GCancellable */
                                                    (GAsyncReadyCallback) smart_start_cb, g_object_ref (data->window));
    }
}

static void
on_selftest_short (GAction *action, GVariant *parameter, gpointer user_data)
{
    DialogData *data = user_data;
...
static void
on_selftest_extended (GAction *action, GVariant *parameter, gpointer user_data)
{
    DialogData *data = user_data;
...
static void
on_selftest_conveyance (GAction *action, GVariant *parameter, gpointer user_data)
{
    DialogData *data = user_data;
...
static void
on_tree_selection_changed (GtkTreeSelection *tree_selection, gpointer user_data)
{
    /* DialogData *data = user_data;*/
}
...
static void
smart_set_enabled_cb (GObject *source_object, GAsyncResult *res, gpointer user_data)
{
    DialogData *data = user_data;
    GError *error = NULL;

    if (!udisks_drive_ata_call_smart_set_enabled_finish (UDISKS_DRIVE_ATA (source_object), res, &error)) {
        gdu_utils_show_error (data->window, _("An error occurred when trying to toggle whether SMART is enabled"),
                                              error);
        g_clear_error (&error);
    }
...
static void
on_enabled_switch_notify_active (GObject *object, GParamSpec *pspec, gpointer user_data)
{
    DialogData *data = user_data;
    gboolean enabled;
    ...
    if (!!enabled != !!udisks_drive_ata_get_smart_enabled (data->ata)) {
        udisks_drive_ata_call_smart_set_enabled (data->ata, enabled, g_variant_new ("a{sv}", NULL), /* options */
                                                 NULL,                                              /* GCancellable */
                                                 (GAsyncReadyCallback) smart_set_enabled_cb, dialog_data_ref (data));
    }
}
...
void
gdu_ata_smart_dialog_show (GtkWindow *parent_window, UDisksObject *object, UDisksClient *client)
{
    DialogData *data;
    guint n;
    ...
    data->dialog = GTK_WIDGET (gdu_application_new_widget ((gpointer) g_application_get_default (),
                                                           "gdu-ata-smart-dialog.ui", "smart-dialog", &data->builder));
    ...
    data->attributes_list = gtk_list_store_new (N_COLUMNS, G_TYPE_INT, /* id */
                                                G_TYPE_STRING,         /* desc */
                                                ...
                                                G_TYPE_INT);           /* flags */
    gtk_tree_sortable_set_sort_column_id (GTK_TREE_SORTABLE (data->attributes_list), ID_COLUMN, GTK_SORT_ASCENDING);
    gtk_tree_view_set_model (GTK_TREE_VIEW (data->attributes_treeview), GTK_TREE_MODEL (data->attributes_list));
    ...
    gtk_tree_view_column_set_attributes (column, renderer, "markup", ID_COLUMN, NULL);
    ...
    renderer = gtk_cell_renderer_text_new ();
    g_object_set (G_OBJECT (renderer), "yalign", 0.5, "ellipsize", PANGO_ELLIPSIZE_MIDDLE, NULL);
    gtk_tree_view_column_pack_start (column, renderer, TRUE);
    gtk_tree_view_column_set_attributes (column, renderer, "markup", DESC_COLUMN, NULL);
    ...
    g_object_set (G_OBJECT (renderer), "yalign", 0.5, NULL);
    gtk_tree_view_column_pack_start (column, renderer, TRUE);
    gtk_tree_view_column_set_attributes (column, renderer, "markup", PRETTY_COLUMN, NULL);
    ...
    g_object_set (G_OBJECT (renderer), "yalign", 0.5, NULL);
    gtk_tree_view_column_pack_start (column, renderer, TRUE);
    gtk_tree_view_column_set_attributes (column, renderer, "markup", NORMALIZED_COLUMN, NULL);
    ...
    g_object_set (G_OBJECT (renderer), "yalign", 0.5, NULL);
    gtk_tree_view_column_pack_start (column, renderer, TRUE);
    gtk_tree_view_column_set_attributes (column, renderer, "markup", THRESHOLD_COLUMN, NULL);
    ...
    g_object_set (G_OBJECT (renderer), "yalign", 0.5, NULL);
    gtk_tree_view_column_pack_start (column, renderer, TRUE);
    gtk_tree_view_column_set_attributes (column, renderer, "markup", WORST_COLUMN, NULL);
    ...
    g_object_set (G_OBJECT (renderer), "yalign", 0.5, NULL);
    gtk_tree_view_column_pack_start (column, renderer, TRUE);
    gtk_tree_view_column_set_attributes (column, renderer, "markup", TYPE_COLUMN, NULL);
    ...
    g_object_set (G_OBJECT (renderer), "yalign", 0.5, NULL);
    gtk_tree_view_column_pack_start (column, renderer, TRUE);
    gtk_tree_view_column_set_attributes (column, renderer, "markup", UPDATES_COLUMN, NULL);
    ...
    g_object_set (G_OBJECT (renderer), "yalign", 0.5, NULL);
    gtk_tree_view_column_set_attributes (column, renderer, "markup", ASSESSMENT_COLUMN, NULL);

    g_signal_connect (gtk_tree_view_get_selection (GTK_TREE_VIEW (data->attributes_treeview)), "changed",
